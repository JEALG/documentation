...
<p><img src="../{{site.img}}/exemple/d/temperature.png" alt="Resultat" /></p>
...
<blockquote>
    <ul>
        ...
        <a href="{{site.baseurl}}/{{site.help}}/{{page.lang}}/size">Changer la Taille du texte de l'historique</a>
    </ul>
</blockquote>
...
<blockquote>
    <ul>
        ...
        <li><a href="{{site.baseurl}}/{{site.help}}/{{page.lang}}/config_info">Aide ajout des paramétres pour un widget Info</a></li>
