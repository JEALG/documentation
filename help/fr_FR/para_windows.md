...
<blockquote>
    <ul>
        ...
        <img src="../img/config_windows_1.png" alt="Visuels" />
        ...
        <img src="../img/config_windows_G.png" alt="Visuels" />
        ...
        <img src="../img/config_windows_D.png" alt="Visuels" />
        ...
        <img src="../img/config_windows_D_G.png" alt="Visuels" />
        ...
        <img src="../img/config_windows_5.png" alt="Visuels" />
        ...
        <img src="../img/config_windows_etat.png" alt="Visuels" />
    </ul>
</blockquote>
<blockquote>
et j'ai configuré l'etat <b>Fenêtres</b>
    <ul>
        ...
        <img src="../img/config_windows_6.png" alt="Visuels" />
        <li>Dans l'onglet <i>configuration</i> dans la partie <i>Affichage</i> : j'affecte les paramétres suivants :
            <ul>
                ...
                <img src="../img/config_windows_aff_1.png" alt="Visuels" />
                    ...
                    <ul>
                        <li><b>Pour l'état 0</b> j'affecte les valeurs suivantes
                            <ul>
                                ...
                                <img src="../img/config_windows_aff_1_0.png" alt="Visuels" />
                            </ul>
                        </li>
                        <li><b>Pour l'état 1</b> j'affecte les valeurs suivantes
                            <ul>
                                ...
                                <img src="../img/config_windows_aff_1_1.png" alt="Visuels" />
                            </ul>
                        </li>
                        <li><b>Pour l'état 2</b> j'affecte les valeurs suivantes
                            <ul>
                                ...
                                <img src="../img/config_windows_aff_1_2.png" alt="Visuels" />
                            </ul>
                        </li>
                        <li><b>Pour l'état 3</b> j'affecte les valeurs suivantes
                            <ul>
                                ...
                                <img src="../img/config_windows_aff_1_3.png" alt="Visuels" />
                            </ul>
                        </li>
                    </ul>
                </li>
...
<p><img src="../img/config_windows_3.png" alt="Visuels" width="500" /></p>
<p><img src="../img/config_windows_4.png" alt="Visuels" width="500" /></p>
