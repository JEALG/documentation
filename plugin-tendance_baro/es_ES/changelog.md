...
- Corrección de un error en la recreación de los comandos
...
- Se ha añadido un widget principal para los controles, excepto para «Tendencia»
- Añadir widget para la tendencia (solo para Core V4)
- Actualización de la documentación
- Modificación de las variables internas de los cálculos

### Versión 20200414

- Solución del error de cálculo de tendencias
...
- Asignación de los valores mínimo y máximo en la «Tendencia numérica»
