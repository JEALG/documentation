...
- Added core widget for commands, except for trend
- Add a widget for the trend (Core V4 only)
- Documentation Update
- Modifying internal calculation variables

### Version 20200414

- Bug Fix: Trend Calculation
...
- Assigning Min and Max Values to the "Numeric Trend"
...
- Correcting history records
- Refresh command (on a tile, scenario, etc.)
- Improvements to logs
- Type of standard correction of opening credits
